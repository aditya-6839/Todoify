                ...
                <Card className="border-border/50 bg-white/70 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl overflow-hidden border">
                    <CardHeader className="space-y-2 text-center pt-10 pb-6">
                        ...
                        <CardDescription className="text-muted-foreground font-medium text-base">
                            The smartest way to manage your day
                        </CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-5 px-8">
                        ...
                        <div className="relative py-2">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-[#fafafa]/80 backdrop-blur-sm px-4 text-muted-foreground/60 font-bold tracking-widest">
                                    or email
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between ml-1">
                                    <Label
                                        htmlFor="password"
                                        className="text-[10px] font-black text-muted-foreground/80 uppercase tracking-[0.2em]"
                                    >
                                        Password
                                    </Label>
                                    <Link to="#" className="text-[10px] font-black text-primary hover:text-primary/80 uppercase tracking-widest transition-colors">
                                        Forgot?
                                    </Link>
                                </div>
                                <div className="relative group">
                    ...
                    <CardFooter className="pb-10 pt-6 px-8">
                        <div className="w-full flex flex-col items-center gap-4">
                            <p className="text-sm text-muted-foreground font-medium">
                                New here? {' '}
                                <Link to="/app/register" className="text-primary font-bold hover:underline underline-offset-4 decoration-2">
                                    Create an account
                                </Link>
                            </p>
